...
public class PartyOutstandingReceivableActivity extends AppCompatActivity implements View.OnClickListener{
    private PartyOutstandingReceivableActivity activity = PartyOutstandingReceivableActivity.this;
    ...
    private TextView tVAsOfDate, tVCancel, tVTitle, tVTotalAmount;

    private LinearLayout lLAsOfDate;

    private HorizontalScrollView scrollMain, scrollTotalMain;
    private RecyclerView rVPartyOutstandingReceivable;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_party_outstanding_receivable);
        init();
        setDate();
    }
    ...
    private void init() {
        ...
        rVPartyOutstandingReceivable = findViewById(R.id.rVPartyOutstandingReceivable);
        ...
        tVTitle.setText("Party Outstanding Receivable");
        rVPartyOutstandingReceivable.addOnScrollListener(new RecyclerView.OnScrollListener() {
            @Override
