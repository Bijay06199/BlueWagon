...
public class PartyAgedPayableActivity extends AppCompatActivity implements View.OnClickListener{
    private PartyAgedPayableActivity activity = PartyAgedPayableActivity.this;
    ...
    private RecyclerView rVPartyAgedPayable;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_party_aged_payable);
        init();
        setDate();
    }
    ...
    private void init() {
        ...
        rVPartyAgedPayable = findViewById(R.id.rVPartyAgedPayable);
        ...
        tVTitle.setText("Party Aged Payable");
        rVPartyAgedPayable.addOnScrollListener(new RecyclerView.OnScrollListener() {
            @Override
