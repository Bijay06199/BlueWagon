...
import com.example.bluewagon.ecalculo.dtos.AddPaymentReceiptDTO;
import com.example.bluewagon.ecalculo.utilities.AppUtil;

import java.util.List;

public class AddPaymenAdapter extends RecyclerView.Adapter<AddPaymenAdapter.ViewHolder>{

    private Context context;
    private LayoutInflater inflater;
    private List<AddPaymentReceiptDTO> addPaymentReceiptDTOList;

    public AddPaymenAdapter(Context context, List<AddPaymentReceiptDTO> addPaymentReceiptDTOList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.row_add_payment, parent, false);
