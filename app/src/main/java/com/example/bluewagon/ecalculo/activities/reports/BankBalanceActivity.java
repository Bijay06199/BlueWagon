...
public class BankBalanceActivity extends AppCompatActivity implements View.OnClickListener{
    private BankBalanceActivity activity = BankBalanceActivity.this;
    ...
    private void init() {
        ...
        rVBankBalance = findViewById(R.id.rVBankBalance);
        ...
        tVTitle.setText("Bank Balance");
        rVBankBalance.addOnScrollListener(new RecyclerView.OnScrollListener() {
            @Override
