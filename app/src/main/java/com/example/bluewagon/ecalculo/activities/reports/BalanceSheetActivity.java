...
public class BalanceSheetActivity extends AppCompatActivity implements View.OnClickListener {
    private BalanceSheetActivity activity = BalanceSheetActivity.this;
    ...
    private RecyclerView rVBalanceSheet;
    ...
    private void init() {
        ...
        rVBalanceSheet = findViewById(R.id.rVBankBalance);
