...
public class PartyAgedReceivableActivity extends AppCompatActivity implements View.OnClickListener {
    private PartyAgedReceivableActivity activity = PartyAgedReceivableActivity.this;
    ...
    private RecyclerView rVPartyAgedReceivable;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_party_aged_receivable);
        init();
        setDate();
    }
    ...
    private void init() {
        ...
        rVPartyAgedReceivable = findViewById(R.id.rVPartyAgedReceivable);
        ...
        tVTitle.setText("Party Aged Receivable");
        rVPartyAgedReceivable.addOnScrollListener(new RecyclerView.OnScrollListener() {
            @Override
