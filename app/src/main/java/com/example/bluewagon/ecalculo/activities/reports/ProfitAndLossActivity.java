...
public class ProfitAndLossActivity extends AppCompatActivity implements View.OnClickListener {
    private ProfitAndLossActivity activity = ProfitAndLossActivity.this;
    ...
    private RecyclerView rVProfitAndLoss;
    ...
    private void init() {
        ...
        rVProfitAndLoss = findViewById(R.id.rVProfitAndLoss);
        ...
        tVTitle.setText("Profit And Loss");
        rVProfitAndLoss.addOnScrollListener(new RecyclerView.OnScrollListener() {
            @Override
